...
| --- | --- | --- |
| **112/142** vermelho ou roxo | **139/142** vermelho ou roxo | máxima **39,4 °C** |
| 78,9% do estado | agravamento disseminado | **23 de 142 (16,2%)** ≥ 37 °C |
...
Distribuição atual: verde 0; amarela 3; laranja 27; vermelha 58; roxa 54. A mediana estadual não descreve o recorte mais exposto: há municípios com calor extremo e material particulado elevado. A projeção de sete dias indica agravamento disseminado e recomenda preparação assistencial nos territórios já em vermelho ou roxo, incluindo populações indígenas, quilombolas e trabalhadores expostos.
...
Distribuição atual: verde 0; amarela 3; laranja 27; vermelha 58; roxa 54.

**Tabela 1 – Indicadores da rodada e municípios em atenção**

| Indicador | Situação da rodada | Municípios em atenção |
| --- | --- | --- |
| Temperatura | mediana 34,8 °C · máximo 39,4 °C | 23 de 142 (16,2%) ≥ 37 °C |
| Umidade | mediana 53% · mínimo 31% | 0 de 142 (0,0%) ≤ 30% |
...
Distribuição projetada: verde 0; amarela 0; laranja 3; vermelha 11; roxa 128
...
**Mapa 1 – Classificação integrada de risco em Mato Grosso, 23 a 29 de agosto de 2026 (atual e ~7 dias)**
...
**Projeção.** 139 de 142 (97,9%) vermelho ou roxo.  
**Agravamento.** 88 de 142 (62,0%) sobem de classe.
...
- Aumento de 1 nível: 69 de 142 (48,6%)
- Aumento de 2 ou mais níveis: 19 de 142 (13,4%)


### Determinantes do agravamento projetado

A projeção operacional (~7 dias) eleva o território de **112 de 142 (78,9%)** para **139 de 142 (97,9%)** municípios nas classes vermelha ou roxa, com **88 de 142 (62,0%)** municípios comparáveis em elevação de classe.
...
| --- | --- | --- |
| Tmáx prevista (máx. 7d ≥ 37 °C) | 49 (55,7% dos que agravam) | ↑ aumento |
| UTCI previsto (máx. 7d ≥ 36 °C) | 34 (38,6% dos que agravam) | ↑ aumento |
...
**Atual:** verde 0; amarela 3; laranja 27; vermelha 58; roxa 54. `OBSERVADO`

**Projeção ~7 dias:** verde 0; amarela 0; laranja 3; vermelha 11; roxa 128. `PROJEÇÃO ARARAS ~7 DIAS`

**Mudança esperada**
- Aumento de 2+ níveis: 19 municípios
- Aumento de 1 nível: 69 municípios
- Estabilidade: 51 municípios
- Melhora: 3 municípios
...
Parâmetro climático oficial para a semana **SE 34/2026** (23 a 29 de agosto de 2026).
...
- **Vendaval** — 1 aviso; severidade Perigo potencial; abrangência em Mato Grosso.
...
- Distribuição da classificação ARARAS desta rodada: verde: 0; amarela: 3; laranja: 27; vermelha: 58; roxa: 54
...
- **Limitação dos dados.** A cobertura hidrológica desta rodada corresponde a 10 de 142 (7,0%); os resultados não devem ser extrapolados para todo o estado. No recorte hidrológico disponível, 8 municípios apresentam sinal de baixa disponibilidade hídrica, 2 apresentam risco elevado de inundação e 0 estão em situação hidrológica habitual. Os sinais de baixa disponibilidade hídrica local **não equivalem** automaticamente à classificação do Monitor de Secas (produto distinto, com outra escala e competência temporal). Índice de saturação do solo: mediana **13/100** (escala normalizada 0–100 a partir de umidade volumétrica Open-Meteo; parâmetro entre ponto de murcha 0,05 e saturação de referência 0,42 m³/m³). **13 pontos** em escala de 0 a 100; sem faixa de interpretação institucional validada nesta rodada.
- Precipitação mediana no **dia de referência operacional**: **0,0 mm** · municípios sem chuva nesse dia: 72 de 142 (50,7%)
...
- Foram registrados 918 focos de calor pelo satélite de referência do Programa Queimadas/INPE (sensor MODIS), utilizado para comparação temporal da série histórica, em 63 de 142 municípios (44,4%) no acumulado de sete dias. O conjunto multi-satélite registrou 45.853 detecções no período; essas detecções não equivalem a 45.853 incêndios ou focos distintos. Colniza concentrou o maior número, com 171 focos no satélite de referência.
- Índice de Qualidade do Ar (IQA) (classes, ordem operacional): verde: 43; amarela: 84; laranja: 14; vermelha: 0; roxa: 1; cinza: 0
- PM2,5 mediano: **16,5 µg/m³** (mín. 9,4; máx. 81,1 µg/m³). P90 da rodada: 25,4 µg/m³. 15 de 142 (10,6%) apresentaram PM2,5 igual ou superior a 25 µg/m³ (parâmetro operacional de atenção sanitária do painel, alinhado a faixas de qualidade do ar). Cobertura espacial: 142 de 142 (100,0%). Interpretação sanitária: exposição à fumaça/partículas finas, com atenção a agravos respiratórios — associação temporal, sem inferência causal.
...
- **Respiratórios/fumaça:** 15 de 142 (10,6%) com PM2,5 ≥ 25 µg/m³ em 28/08/2026.
- **Calor/desidratação:** Calor: 23 municípios apresentaram Tmáx ≥ 37 °C; 134 apresentaram UTCI ≥ 32 °C. O indicador combinado de calor seco (Tmáx ≥ 37 °C e UR ≤ 30%) não foi observado nesta rodada.
- **Arboviroses:** 197 casos em 7 dias no recorte com dado (ausência não é zero).
- **Baixa disponibilidade hídrica:** 8 municípios no recorte hidrológico disponível.
- **Risco elevado de inundação:** 2 municípios no recorte hidrológico disponível.
...
| --- | --- | --- | --- |
| Sinop | 15 | ↑ 7 · → 8 | 34,2 °C |
| Baixada Cuiabana | 10 | ↑ 5 · → 6 | 37,1 °C |
| Cáceres | 10 | ↑ 5 · → 6 · ↓ 1 | 35,1 °C |
| Tangará da Serra | 9 | ↑ 5 · → 5 | 35,4 °C |
| Água Boa | 8 | ↑ 0 · → 8 | 37,4 °C |
| Barra do Garças | 8 | ↑ 5 · → 4 · ↓ 1 | 36,7 °C |
| Porto Alegre do Norte | 7 | ↑ 5 · → 2 | 35,3 °C |
| Rondonópolis | 6 | ↑ 17 · → 2 | 35,5 °C |
...
**Leitura regional.** A maior concentração nas classes vermelha e roxa está em **Sinop** (15 municípios). O maior número de municípios em aumento de classe na projeção de sete dias concentra-se em **Rondonópolis** (17 em elevação). A maior mediana regional de Tmáx no recorte é **37,4 °C** (Água Boa). A atenção imediata permanece nas regionais **Sinop** e **Baixada Cuiabana**, com reforço assistencial nos municípios já em vermelho ou roxo.
...
| --- | --- | --- | --- | --- | --- |
| Nossa Senhora do Livramento | Baixada Cuiabana | Roxa → Roxa | 95,7 | Crítica | exposição ambiental |
| Rosário Oeste | Diamantino | Roxa → Roxa | 88,6 | Crítica | exposição ambiental |
| Poconé | Baixada Cuiabana | Roxa → Roxa | 80,0 | Crítica | pressão assistencial |
| Chapada dos Guimarães | Baixada Cuiabana | Vermelha → Roxa | 78,1 | Crítica | pressão assistencial |
| Cuiabá | Baixada Cuiabana | Roxa → Roxa | 77,5 | Crítica | prioridade operacional |
| Acorizal | Baixada Cuiabana | Roxa → Roxa | 77,2 | Crítica | exposição ambiental |
| Cáceres | Cáceres | Roxa → Roxa | 77,1 | Crítica | prioridade operacional |
| Campinápolis | Barra do Garças | Roxa → Roxa | 76,8 | Crítica | vulnerabilidade |
...
- Regionais com maior concentração nas classes vermelha e roxa: **Sinop, Baixada Cuiabana, Cáceres, Tangará da Serra, Água Boa**.
- Maior Tmáx municipal: **Cocalinho** (39,4 °C).
- Maior PM2,5 municipal: **Marcelândia** — 81,1 µg/m³.
- Maior acumulado no satélite de referência: **Colniza** — 171 focos.
- Persistência: estabilidade de classe em 51 de 142 (35,9%).
- Melhora projetada: 3 de 142 (2,1%).
...
- **Feliz Natal** — 43 aldeias — Roxa → Roxa — fogo.
- **Aripuanã** — 41 aldeias — Vermelha → Roxa — múltiplas exposições (fumaça/PM2,5, fogo).
- **Tangará da Serra** — 37 aldeias — Roxa → Roxa — fogo.
- **Brasnorte** — 32 aldeias — Vermelha → Roxa — sem exposição específica destacada além do risco integrado.
...
- Situação: 8 municípios com sinal hidrológico de baixa disponibilidade no recorte disponível.
...
- Situação: 15 de 142 (10,6%) municípios com PM2,5 ≥ 25 µg/m³.
...
- Situação: foi identificado sinal de risco elevado de inundação em 2 municípios no recorte hidrológico disponível. A cobertura hidrológica corresponde a apenas 10 de 142 (7,0%); portanto, o achado deve ser interpretado como sinal localizado e não permite caracterização do cenário estadual.
...
Evidência transversal desta rodada: situação atual 112 de 142 (78,9%) nas classes vermelha e roxa; projeção 139 de 142 (97,9%); 88 de 142 (62,0%) em agravamento.
...
- **SEMA-MT** — compartilhar o cenário de qualidade do ar, focos de calor e territórios prioritários para avaliação ambiental integrada (PM2,5 elevado em 15 municípios).
- **Defesa Civil Estadual** — compartilhar municípios classificados em níveis elevados e a projeção para os próximos sete dias.
- **Corpo de Bombeiros Militar** — articular informações sobre incêndios florestais nos territórios prioritários (acumulado de 918 focos no satélite de referência INPE em sete dias; 45.853 detecções multi-satélite).
...
A Semana Epidemiológica mantém cenário de **elevada atenção** em Mato Grosso, com **112 de 142 (78,9%)** municípios nas classes vermelha ou roxa no momento da emissão. O padrão territorial da rodada é marcado por calor e exposição à fumaça/material particulado, em contexto de avisos meteorológicos de baixa umidade emitidos pelo INMET.

As maiores concentrações de risco encontram-se em **Sinop, Baixada Cuiabana, Cáceres**, entre outras regionais. A sobreposição com aldeias indígenas e municípios com comunidades quilombolas certificadas reforça a necessidade de abordagem territorial e articulação específica.
...
Para os próximos sete dias, a projeção indica **agravamento disseminado**: **88 de 142 (62,0%)** municípios comparáveis apresentam elevação da classificação, sendo 69 com aumento de um nível e 19 com aumento de dois ou mais níveis. Três municípios apresentam melhora projetada e 51 permanecem estáveis. Ao final do horizonte projetado, **139 de 142 (97,9%)** estarão nas classes vermelha ou roxa, caso o cenário estimado se confirme. A projeção apresenta elevada concentração nas classes superiores e deve ser reavaliada nas rodadas subsequentes, especialmente diante da ampla influência dos componentes de persistência térmica e onda de calor.


A magnitude da mudança projetada exige acompanhamento das próximas rodadas e interpretação dos determinantes do modelo, especialmente porque a situação observada no momento da emissão apresenta **112 de 142 (78,9%)** nas classes vermelha ou roxa. Alertas oficiais vigentes do Instituto Nacional de Meteorologia (INMET) nesta emissão: 2.
...
CENTRO NACIONAL DE MONITORAMENTO E ALERTAS DE DESASTRES NATURAIS. Painel de alertas. Cachoeira Paulista: CEMADEN, 2026. Disponível em: https://painelalertas.cemaden.gov.br/. Acesso em: 28 ago. 2026.
...
INSTITUTO NACIONAL DE METEOROLOGIA. Avisos meteorológicos — feed RSS Alert-AS. Brasília: INMET, 2026. Disponível em: https://apiprevmet3.inmet.gov.br/avisos/rss. Acesso em: 28 ago. 2026.
...
INSTITUTO NACIONAL DE PESQUISAS ESPACIAIS. Programa Queimadas / BDQueimadas. Portal de monitoramento de focos de calor. São José dos Campos: INPE, 2026. Disponível em: https://terrabrasilis.dpi.inpe.br/queimadas/portal/. Acesso em: 28 ago. 2026.
...
NATIONAL OCEANIC AND ATMOSPHERIC ADMINISTRATION. Climate Prediction Center. El Niño–Oscilação Sul (ENSO) Diagnostic Discussion. Silver Spring: NOAA, 2026. Disponível em: https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/ensodisc.shtml. Acesso em: 28 ago. 2026.
OPEN-METEO. Weather Forecast API: documentação técnica. 2026. Disponível em: https://open-meteo.com/en/docs. Acesso em: 28 ago. 2026.
