...
- **Risco cumulativo 3d:** 6.7 agora vs média 3.2 nos setembros anteriores (risco térmico acima do padrão do período; z=+2.15).
...
- **Precipitação média (mm):** 1.6 vs média 1.1 (z=+0.34).
- **Precipitação acumulada (mm):** 29.4 vs média 29.9 (z=-0.04).

**Acumulado do ano (YTD) — 01/01/2026 a 18/09/2026**

Mesmo intervalo calendário (1º jan → 18/09) nos anos **2022, 2023, 2024, 2025** (1045 dias históricos).
...
![Sazonalidade histórico × atual](_assets_SE_37-2026/grafico_sazonalidade_historico_atual.png)
...
**Mapa 1 – Classificação integrada de risco em Mato Grosso, 13 a 19 de setembro de 2026 (atual e ~7 dias)**
...
Semana **SE 37/2026** (13 a 19 de setembro de 2026). Recorte: **Mato Grosso** (avisos INMET exclusivos de MS excluídos).
...
- **Baixa Umidade** — 2 avisos; severidade Perigo potencial; **141** municípios; por regional SES: Rondonópolis (19); Sinop (14); Cáceres (12); Baixada Cuiabana (11); Barra do Garças (10); Pontes e Lacerda (10); +10 regionais. Exemplos: Acorizal, Alta Floresta, Alto Araguaia, Alto Boa Vista, Alto Garças, Alto Paraguai, Alto Taquari, Apiacás ….
- **Tempestade** — 1 aviso; severidade Perigo potencial; **61** municípios; por regional SES: Rondonópolis (17); Cáceres (12); Baixada Cuiabana (9); Tangará da Serra (8); Pontes e Lacerda (7); Barra do Garças (5); +1 regionais. Exemplos: Acorizal, Alto Araguaia, Alto Garças, Alto Paraguai, Alto Taquari, Araguainha, Araputanga, Arenápolis ….
...
![Vulneráveis APS](_assets_SE_37-2026/grafico_esus_vulneraveis_classe.png)
...
- **Janela:** 2026-09-02 a 2026-09-15 · **142** municípios com série EHF.
- **Temporada operacional (série disponível):** 2026-04-28 a 2026-09-15 (mediana de municípios em onda/dia: **0** · P75: **0**).
- **Último dia da série (2026-09-15):** **0** municípios em dia de onda (baixa **0** · severa **0** · extrema **0**).
- **Na janela (série diária):** **0** municípios com ≥ 1 dia de onda.
- **Na janela (eventos reconciliados ≥ 3 dias):** **0** eventos em **0** municípios (baixa **0** · severa **0** · extrema **0**).
- **Cuiabá (EHF):** 0 dia(s) de onda na janela · EHF máx. **-1.64** · pico de intensidade **—** · em onda no último dia da série: **não**.
...
![GeoCalor EHF](_assets_SE_37-2026/grafico_geocalor_ehf_janela.png)

Fonte: cálculo EHF estadual ARARAS (definição GeoCalor / Nairn & Fawcett). Temporada operacional 2026-04-28 a 2026-09-15; janela do boletim destacada 2026-09-02 a 2026-09-15. Canal = P25–P75 móvel de 14 dias sobre a série operacional — não substitui climatologia oficial de longo prazo.
...
| --- | --- | --- |
| Novo Santo Antônio | 40,2 °C | 2026-09-14 |
| Araguaiana | 40,1 °C | 2026-09-18 |
| Nova Nazaré | 40,1 °C | 2026-09-13 |
| Ribeirão Cascalheira | 40,0 °C | 2026-09-14 |
...
![Picos de Tmáx](_assets_SE_37-2026/grafico_picos_tmax_semana.png)
...
| --- | --- | --- |
| Chapada dos Guimarães | Baixada Cuiabana | 11258 |
| Jangada | Baixada Cuiabana | 1822 |
| Acorizal | Baixada Cuiabana | 1789 |
| Nova Canaã do Norte | Colíder | 1673 |
| Carlinda | Alta Floresta | 1660 |
| Alto Paraguai | Diamantino | 1550 |
| Novo Mundo | Peixoto de Azevedo | 1469 |
| Barão de Melgaço | Baixada Cuiabana | 1279 |
| Denise | Tangará da Serra | 1278 |
| Porto Esperidião | Cáceres | 1224 |
...
| --- | --- | --- | --- | --- | --- |
| CUIABÁ | roxa | 551 | 10,4 | 37,4 | 68.748 |
| SINOP | roxa | 286 | 16,2 | 35,6 | 29.899 |
| CÁCERES | roxa | 255 | 11,3 | 35,9 | 14.908 |
| LUCAS DO RIO VERDE | roxa | 191 | 15,5 | 36,5 | 16.525 |
| RONDONÓPOLIS | roxa | 177 | 10,3 | 37,7 | 24.989 |
...
![Temperaturas diárias Cuiabá](_assets_SE_37-2026/serie_cuiaba_temperaturas_diarias.png)

Fonte: Open-Meteo Archive (ponto Cuiabá). Período observado 1981-01-01 a 2026-09-18.

**Figura 6 – Amplitude térmica diária em Cuiabá — observado**

![Amplitude térmica Cuiabá](_assets_SE_37-2026/serie_cuiaba_amplitude_termica.png)

Fonte: Open-Meteo Archive (máxima − mínima diária) com média móvel de 30 dias. Série observada.

**Figura 7 – Série climática operacional estadual (Tmáx mensal, 2021-09-18 a 2026-09-18) — observado**

![Série climática Tmáx](_assets_SE_37-2026/serie_climatica_tmax.png)
...
**Tabela 11 – Componentes do RIT (Risco Integrado Territorial)**
...
**Tabela 12 – Termos utilizados neste boletim**
...
NATIONAL OCEANIC AND ATMOSPHERIC ADMINISTRATION. Climate Prediction Center. ENSO Diagnostic Discussion. Silver Spring: NOAA, 2026. Disponível em: https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/ensodisc.shtml. Acesso em: 19 set. 2026.
OPEN-METEO. Weather Forecast API: documentação técnica. 2026. Disponível em: https://open-meteo.com/en/docs. Acesso em: 19 set. 2026.
