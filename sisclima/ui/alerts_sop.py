...
CRITERIOS_ESCALONAMENTO = [
    ...
    {
        "gatilho": "Aldeias, quilombos ou assentamentos em município com fumaça/seca/cheia",
        "acao": "Cruzar Vigibarragens × cenário climático; articular SESAI/DSEI, APS rural e Defesa Civil",
        "prazo": "Mesmo plantão",
        "decisao_humana": "Não usar distância ao eixo de barragem como cota de inundação",
    },
]
