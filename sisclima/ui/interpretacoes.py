...
GUIDE_PRONTIDAO = guide_card(
    ...
    [
        ...
        "<b>IPMEC</b>: 0–100 combinando farmácia, CNES, água, vigilância e vulnerabilidade. Lacunas são explícitas.",
        "<b>Plano</b>: 0–24 h, 24–72 h e 3–7 dias. A IA só aplica a matriz validada (não prescreve).",
        "<b>Territórios</b>: aldeias FUNAI, quilombos Palmares, assentamentos INCRA e barragens DPA alto (Vigibarragens). Distância ao eixo ≠ inundação.",
    ],
)
...
GUIDE_MAPAS = guide_card(
    ...
    [
        ...
        "<b>Territórios</b>: aldeias, quilombos e assentamentos vêm do Vigibarragens (pontos). Distância ao eixo de barragem não é cota de inundação.",
