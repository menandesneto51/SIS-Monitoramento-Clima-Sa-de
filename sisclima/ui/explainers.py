...
SECTION_GUIDES: dict[str, dict[str, str]] = {
    ...
    "Cenário Epidemiológico": {
        "para_que_serve": "Acompanhar arboviroses e demais agravos sensíveis ao clima (SINAN extras, fumaça, internações, SRAG/malária).",
        "como_usar": "Use as abas internas: arboviroses 7d, extras SINAN, intoxicação/fumaça, internações CID e malária/SRAG.",
        "cuidado": "Ausência de linha ≠ zero. Série SIVEP completa continua na aba SIVEP / Sentinela.",
    },
    "Arboviroses": {
...
HOW_TO_READ_PUBLIC = [
    ...
    "8. Em Cenário Epidemiológico, acompanhe arboviroses e demais agravos sensíveis ao clima.",
