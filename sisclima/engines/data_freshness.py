...
FONTES: list[dict[str, Any]] = [
    ...
    {
        "fonte_id": "indicasus",
        "fonte_nome": "IndicaSUS / ocupação",
        "tabela": "hospital_ocupacao_municipio",
        "date_cols": ["data_referencia", "atualizado_em", "data"],
        "ibge": True,
        "tipo": "assistencial",
        "ok_max": 2,
        "atrasado_max": 5,
    ...
    {
        "fonte_id": "ana_telemetria",
        "fonte_nome": "ANA telemetria / níveis de rios",
        "tabela": "niveis_rios_municipal",
        "date_cols": ["data_referencia", "atualizado_em"],
        "ibge": True,
        "tipo": "operacional",
        "ok_max": 2,
    ...
    {
        "fonte_id": "dw_sinan",
        "fonte_nome": "DW SINAN (derivado)",
        "tabela": "epi_arboviroses_municipal",
        "date_cols": ["data", "atualizado_em"],
        "ibge": True,
        "tipo": "epidemiologico",
        "ok_max": 7,
        "atrasado_max": 21,
