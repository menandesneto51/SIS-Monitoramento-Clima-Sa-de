...
KEYWORDS = {
    ...
    # Multi-ameaça (Cemaden / hidrologia / seca)
    'alagamento': 4, 'alagada': 4, 'enchente': 5, 'inundação': 5, 'inundacao': 5,
    'enxurrada': 4, 'deslizamento': 5, 'desmoronamento': 5, 'movimento de massa': 4,
    'seca': 3, 'estiagem': 3, 'cemaden': 3, 'chuva intensa': 3, 'temporal': 3,
}
