...
ENV_ALIASES: dict[str, list[str]] = {
    ...
    'USE_VIGIBARRAGENS': ['USE_VIGIBARRAGENS', 'VIGIBARRAGENS_ENABLED', 'USAR_VIGIBARRAGENS', 'USE_SIGBM'],
    'VIGIBARRAGENS_URL': ['VIGIBARRAGENS_URL', 'SIGBM_URL', 'ANM_BARRAGENS_URL', 'URL_VIGIBARRAGENS'],
    'VIGIBARRAGENS_UF': ['VIGIBARRAGENS_UF', 'UF_VIGIBARRAGENS', 'SIGBM_UF'],
    'VIGIBARRAGENS_SSL_VERIFY': ['VIGIBARRAGENS_SSL_VERIFY', 'ALERT_SSL_VERIFY'],
    'VIGIBARRAGENS_CSV': ['VIGIBARRAGENS_CSV', 'CSV_VIGIBARRAGENS', 'SIGBM_CSV', 'BARRAGENS_CSV'],
    ...
    # Controle de acesso (admin inicial do painel)
    'ARARAS_ADMIN_EMAIL': ['ARARAS_ADMIN_EMAIL', 'ADMIN_EMAIL', 'PAINEL_ADMIN_EMAIL'],
    'ARARAS_ADMIN_PASSWORD': ['ARARAS_ADMIN_PASSWORD', 'ADMIN_PASSWORD', 'PAINEL_ADMIN_PASSWORD', 'ARARAS_ADMIN_SENHA'],
    'ARARAS_ADMIN_NOME': ['ARARAS_ADMIN_NOME', 'ADMIN_NOME', 'PAINEL_ADMIN_NOME'],
