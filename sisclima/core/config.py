...
ENV_ALIASES: dict[str, list[str]] = {
    ...
    # e-SUS APS / Centralizador Postgres (fonte externa — NÃO usar DATABASE_URL)
    'USE_ESUS_APS': ['USE_ESUS_APS', 'USAR_ESUS_APS', 'ESUS_APS_ENABLED', 'ESUS_ENABLED'],
    'ESUS_APS_HOST': ['ESUS_APS_HOST', 'ESUS_HOST', 'ESUS_APS_SERVER', 'ESUS_SERVER', 'CENTRALIZADOR_ESUS_HOST'],
    'ESUS_APS_PORT': ['ESUS_APS_PORT', 'ESUS_PORT'],
    'ESUS_APS_DATABASE': ['ESUS_APS_DATABASE', 'ESUS_APS_DB', 'ESUS_DATABASE', 'ESUS_DB'],
    'ESUS_APS_USER': ['ESUS_APS_USER', 'ESUS_USER', 'ESUS_APS_USERNAME', 'ESUS_USERNAME'],
    'ESUS_APS_PASSWORD': ['ESUS_APS_PASSWORD', 'ESUS_PASSWORD', 'ESUS_APS_PASS', 'ESUS_PASS'],
    'ESUS_APS_SSLMODE': ['ESUS_APS_SSLMODE', 'ESUS_SSLMODE'],
    'ESUS_APS_CONNECT_TIMEOUT': ['ESUS_APS_CONNECT_TIMEOUT', 'ESUS_CONNECT_TIMEOUT'],
    'ESUS_APS_QUERY_TIMEOUT_SECONDS': ['ESUS_APS_QUERY_TIMEOUT_SECONDS', 'ESUS_QUERY_TIMEOUT_SECONDS'],
    'ESUS_APS_SCHEMA': ['ESUS_APS_SCHEMA', 'ESUS_SCHEMA'],
    ...
    'COPERNICUS_CDS_URL': ['COPERNICUS_CDS_URL', 'CDS_CLIMATE_URL'],
    'COPERNICUS_CDS_KEY': ['COPERNICUS_CDS_KEY', 'CDS_CLIMATE_KEY'],
    'USE_STAR_GEOCALOR': ['USE_STAR_GEOCALOR', 'STAR_GEOCALOR_ENABLED'],
    'STAR_ETL_FONTE': ['STAR_ETL_FONTE', 'STAR_FONTE'],
    'STAR_CDS_ETL_DAYS': ['STAR_CDS_ETL_DAYS', 'STAR_ETL_DAYS'],
    'STAR_ETL_SKIP_FETCH': ['STAR_ETL_SKIP_FETCH'],
    ...
    'SMTP_HOST': ['SMTP_HOST', 'EMAIL_SMTP_HOST', 'EMAIL_HOST', 'MAIL_SERVER', 'MAIL_HOST'],
    'SMTP_PORT': ['SMTP_PORT', 'EMAIL_SMTP_PORT', 'EMAIL_PORT', 'MAIL_PORT'],
    'SMTP_SSL': ['SMTP_SSL', 'EMAIL_USE_SSL', 'MAIL_USE_SSL'],
    'SMTP_FROM': ['SMTP_FROM', 'EMAIL_FROM', 'EMAIL_REMETENTE', 'MAIL_FROM', 'SMTP_SENDER'],
