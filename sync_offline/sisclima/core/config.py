...
ENV_ALIASES: dict[str, list[str]] = {
    ...
    'DW_TRUST_SERVER_CERTIFICATE': ['DW_TRUST_SERVER_CERTIFICATE', 'SQLSERVER_TRUST_SERVER_CERTIFICATE', 'TRUST_SERVER_CERTIFICATE', 'TrustServerCertificate'],
    'DW_QUERY_TIMEOUT_SECONDS': ['DW_QUERY_TIMEOUT_SECONDS', 'SQLSERVER_QUERY_TIMEOUT_SECONDS', 'QUERY_TIMEOUT_SECONDS'],

    # IndicaSUS dedicado (BdSES)
    'INDICASUS_SERVER': ['INDICASUS_SERVER', 'INDICASUS_HOST', 'INDICASUS_SQL_SERVER'],
    'INDICASUS_DATABASE': ['INDICASUS_DATABASE', 'INDICASUS_DB', 'INDICASUS_DATABASE_NAME'],
    'INDICASUS_USER': ['INDICASUS_USER', 'INDICASUS_LOGIN', 'INDICASUS_USERNAME'],
    'INDICASUS_PASSWORD': ['INDICASUS_PASSWORD', 'INDICASUS_PASS', 'INDICASUS_PWD', 'INDICASUS_SENHA'],
    'INDICASUS_PORT': ['INDICASUS_PORT'],
    'INDICASUS_DRIVER': ['INDICASUS_DRIVER'],
    'INDICASUS_ENCRYPT': ['INDICASUS_ENCRYPT'],
    'INDICASUS_TRUST_SERVER_CERTIFICATE': ['INDICASUS_TRUST_SERVER_CERTIFICATE'],
    'INDICASUS_USE_DW_CREDENTIALS': ['INDICASUS_USE_DW_CREDENTIALS', 'INDICASUS_USE_DW'],
    'USE_INDICASUS_OCCUPANCY_SCRIPT': ['USE_INDICASUS_OCCUPANCY_SCRIPT', 'RUN_INDICASUS_OCCUPANCY_SCRIPT'],

    # SISREG (pressão assistencial)
    'SISREG_SERVER': ['SISREG_SERVER', 'SISREG_HOST', 'SISREG_SQL_SERVER'],
    'SISREG_DATABASE': ['SISREG_DATABASE', 'SISREG_DB'],
    'SISREG_USER': ['SISREG_USER', 'SISREG_LOGIN', 'SISREG_USERNAME'],
    'SISREG_PASSWORD': ['SISREG_PASSWORD', 'SISREG_PASS', 'SISREG_PWD', 'SISREG_SENHA'],
    'SISREG_PORT': ['SISREG_PORT'],
    'SISREG_DRIVER': ['SISREG_DRIVER'],
    'SISREG_ENCRYPT': ['SISREG_ENCRYPT'],
    'SISREG_TRUST_SERVER_CERTIFICATE': ['SISREG_TRUST_SERVER_CERTIFICATE'],
    'USE_SISREG': ['USE_SISREG', 'USAR_SISREG', 'SISREG_ENABLED'],
    'USE_DW_SIH': ['USE_DW_SIH', 'USE_DW_INTERNACAO', 'USAR_SIH_DW'],
    ...
    'RUN_PREFLIGHT': ['RUN_PREFLIGHT', 'PREFLIGHT_ENABLED', 'GATE_PREFLIGHT'],
    ...
    'SMTP_FROM': ['SMTP_FROM', 'EMAIL_FROM', 'EMAIL_REMETENTE'],
    'SMTP_USER': ['SMTP_USER', 'EMAIL_USER'],
    'SMTP_PASSWORD': ['SMTP_PASSWORD', 'EMAIL_PASSWORD', 'EMAIL_SENHA'],
    'SMTP_SSL': ['SMTP_SSL', 'EMAIL_SSL', 'SMTP_USE_SSL'],
    'ALERT_EMAIL_TO': ['ALERT_EMAIL_TO', 'EMAIL_TO', 'EMAIL_DESTINATARIO', 'DESTINATARIOS_EMAIL', 'ALERTA_EMAIL_DESTINATARIOS'],
    ...
    'TELEGRAM_CHAT_ID': ['TELEGRAM_CHAT_ID', 'CHAT_ID_TELEGRAM', 'TELEGRAM_CHAT', 'TG_CHAT_ID'],
    ...
    'FORCE_ALERT_SEND': ['FORCE_ALERT_SEND', 'ALERT_FORCE_SEND', 'FORCAR_ALERTA'],
    'USE_INDICASUS_OCCUPANCY_SCRIPT': ['USE_INDICASUS_OCCUPANCY_SCRIPT', 'RUN_INDICASUS_OCCUPANCY_SCRIPT'],
    'USE_AI_ALERT_TEXT': ['USE_AI_ALERT_TEXT', 'ALERT_AI_TEXT', 'USAR_IA_ALERTA'],
    'GEMINI_API_KEY': ['GEMINI_API_KEY', 'GOOGLE_API_KEY', 'GOOGLE_GEMINI_API_KEY'],
    'GEMINI_MODEL': ['GEMINI_MODEL', 'GOOGLE_GEMINI_MODEL'],
    'ALERT_SSL_VERIFY': ['ALERT_SSL_VERIFY', 'REQUESTS_SSL_VERIFY', 'SSL_VERIFY'],
    'EPI_LOOKBACK_DAYS': ['EPI_LOOKBACK_DAYS', 'JANELA_EPI_DIAS', 'LOOKBACK_EPI_DIAS'],
    'ALERT_VIGIA_CATEGORIAS': ['ALERT_VIGIA_CATEGORIAS', 'VIGIA_ALERT_CATEGORIES'],
    'ALERT_VIGIA_MUNICIPIOS_MIN_SCORE': ['ALERT_VIGIA_MUNICIPIOS_MIN_SCORE', 'VIGIA_MUNICIPIOS_MIN_SCORE'],
    'ALERT_VIGIA_MAX_MUNICIPIOS': ['ALERT_VIGIA_MAX_MUNICIPIOS', 'VIGIA_MAX_MUNICIPIOS'],
    'ALERT_VIGIA_SEND_DELAY_SECONDS': ['ALERT_VIGIA_SEND_DELAY_SECONDS', 'VIGIA_SEND_DELAY_SECONDS'],
