-- Arboviroses adicionais do SINAN (Zika, Chikungunya e correlatas).
-- Carregado de forma independente para não quebrar a consulta principal
-- caso alguma view específica não exista no DW.
