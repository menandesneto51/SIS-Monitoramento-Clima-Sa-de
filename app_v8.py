# -*- coding: utf-8 -*-
"""
SIS Integrado Clima-Saúde MT - Dashboard V8
...
Rodar:
.venv\\Scripts\\python.exe -m streamlit run app_v8.py
"""
...
for df in [met, aq, occ, press, stock, infra, ops_cnes, saude_calor_mun, gal_pos_mun, sim_obitos_mun, alerta_mun_v6, pred_v6, pred_reg_v6, analise_base_v8, analise_alertas_v8]:
